...
public class SMSUtil {
    ...
    private static final String ACCOUNT_SID="583a5ffb551443feb3dafcc61426aef3";
    private static final String AUTH_TOKEN="40f5cbf841c14b6badaffb8ebf908d0d";


    //根据相应的手机号发送验证码
    public static String getCode(String rod,String phone){
        //String rod=smsCode();
        //System.out.println("验证码&&&&&&&&&&&&&&&&&"+rod);
        String timestamp=getTimestamp();
        String sig=getMD5(ACCOUNT_SID,AUTH_TOKEN,timestamp);
        int time=5;
        String tamp="【南京慧水】您的验证码为"+rod+"，请于"+time+"分钟内正确输入，如非本人操作，请忽略此短信。";
